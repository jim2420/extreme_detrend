...
dat=NetCDFFile('maizeflood_pp.nc','r')
iyield1ynew = dat.variables['g_Precip'][0:115,7,0,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('maizeflood_pp.nc','r')
iyield2ynew = dat2.variables['g_Precip'][0:115,7,0,:,:]
...
ncfile=NetCDFFile('mai1901_2015region_ppflood.nc','w',format='NETCDF3_64BIT_OFFSET')
