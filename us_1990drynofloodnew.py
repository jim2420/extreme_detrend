...
mai=NetCDFFile('outputnew.nc','r')
maiir = mai.variables['totalyield'][:,:,:]
mai1=NetCDFFile('outputnew.nc','r')
...
maiir_avg=scipy.signal.detrend(maiir[12:35,:,:],axis=0)#1990-2012
mai_avg=scipy.signal.detrend(mai[12:35,:,:],axis=0)
...
gg=N.zeros(23)
gg=N.arange(1,24)
linear=N.zeros((23,360,720))
linear_irr=N.zeros((23,360,720))
slope_irr=N.zeros((360,720))
intercept_irr=N.zeros((360,720))

for i in range(0,360):
	for j in range(0,720):
	        slope[i,j], intercept[i,j], r_value, p_value, std_err = scipy.stats.linregress(gg,mai[12:35,i,j])
                slope_irr[i,j], intercept_irr[i,j], r_value, p_value, std_err = scipy.stats.linregress(gg,maiir[12:35,i,j])
...
plt.savefig('isamdry_1990_2012usoutputnew.jpg',bbox_inches='tight')
