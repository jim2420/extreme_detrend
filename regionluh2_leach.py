...
iyield1ynew = dat.variables['leaching'][0:115,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('mai_fert_n.nc','r')
iyield2ynew = dat2.variables['leaching'][0:115,:,:]
...
ncfile=NetCDFFile('mai1901_2015region_leach.nc','w',format='NETCDF3_64BIT_OFFSET')
