...
dat=NetCDFFile('mai_irr_fert_tt.nc','r')
iyield1ynew = dat.variables['g_Temp'][0:115,7,0,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]

dat2=NetCDFFile('mai_fert_tt.nc','r')
iyield2ynew = dat2.variables['g_Temp'][0:115,7,0,:,:]


iyield1ynew[N.isnan(iyield1ynew)]=0.0
iyield2ynew[N.isnan(iyield2ynew)]=0.0
...
ncfile=NetCDFFile('mai1901_2015regionnewtt.nc','w',format='NETCDF3_64BIT_OFFSET')
