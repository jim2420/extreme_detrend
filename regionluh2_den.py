...
def region(x,ryield):
	...
	meareaisam1 = isam1.variables['fmai_tt'][1150,:,:]#2015
...
dat=NetCDFFile('mai_irr_fert_n.nc','r')
iyield1ynew = dat.variables['denitrification'][0:115,:,:]
latisam=dat.variables['lat'][:]
lonisam=dat.variables['lon'][:]
dat2=NetCDFFile('mai_fert_n.nc','r')
iyield2ynew = dat2.variables['denitrification'][0:115,:,:]
...
ncfile=NetCDFFile('mai1901_2015region_den.nc','w',format='NETCDF3_64BIT_OFFSET')
