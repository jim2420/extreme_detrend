...
maiir_avg=scipy.signal.detrend(maiir[60:115,:,:],axis=0)#1961-2015
mai_avg=scipy.signal.detrend(mai[60:115,:,:],axis=0)

maiir_avg1=N.median(maiir_avg,axis=0)
maiir_avg1,lona1 = shiftgrid(180.5,maiir_avg1,lona,start=False)

print maiir[60:115,255,546]
print maiir_avg[:,255,546]
slope=N.zeros((360,720))
intercept=N.zeros((360,720))
gg=N.zeros(55)
gg=N.arange(1,56)
linear=N.zeros((55,360,720))
linear_irr=N.zeros((55,360,720))
slope_irr=N.zeros((360,720))
intercept_irr=N.zeros((360,720))

for i in range(0,360):
	for j in range(0,720):
	        slope[i,j], intercept[i,j], r_value, p_value, std_err = scipy.stats.linregress(gg,mai[60:115,i,j])
                slope_irr[i,j], intercept_irr[i,j], r_value, p_value, std_err = scipy.stats.linregress(gg,maiir[60:115,i,j])
