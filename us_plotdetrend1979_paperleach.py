...
map = Basemap(llcrnrlon=-102.5,llcrnrlat=20,urcrnrlon=-62,urcrnrlat=51,
...
plt.axis('off')
cbar = fig.colorbar(cs1,ax=ax1,pad=0.002,shrink=0.6,aspect=12,ticks=bounds)
...
plt.savefig('isam2012dry_1979_2012leach.jpg',bbox_inches='tight')
